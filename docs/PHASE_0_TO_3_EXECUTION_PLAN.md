...
Phase 4 v1은 위 후보 중 **텍스처/머티리얼 일반화 + 간단 조명**과 **씬 데이터 직렬화** 두 트랙으로 스코프가 확정됐다. 단계별 순서·파일·검증 기준은 [PHASE_4_EXECUTION_PLAN.md](/D:/Work/Projects/BlueFrog/docs/PHASE_4_EXECUTION_PLAN.md)를 본다.
