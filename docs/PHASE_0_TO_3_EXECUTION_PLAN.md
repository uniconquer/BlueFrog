...
Phase 5는 위에서 "씬 데이터 직렬화"가 깐 JSON 로더 위에 **프리팹 + 다중 씬 + 트리거 + 로더 검증**을 얹는다. 실행 계획: [PHASE_5_EXECUTION_PLAN.md](/D:/Work/Projects/BlueFrog/docs/PHASE_5_EXECUTION_PLAN.md).
